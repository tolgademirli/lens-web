    ...
    >
      <div className="space-y-4 mb-8">
        ...
        {entries.length > 0 && entries.length < minEntries && (
          ...
          >
            <p className="text-sm text-amber-200">
              En az {minEntries - entries.length} kitap daha eklemelisin
            </p>
          </motion.div>
        )}
        ...
        {entries.length > minEntries && entries.length < maxEntries && (
          ...
          >
            <p className="text-sm text-emerald-200">
              ✅ {entries.length} kitap eklendi. Devam edebilir veya {maxEntries - entries.length} tane daha ekleyebilirsin.
            </p>
          </motion.div>
        )}
        ...
        {entries.length === maxEntries && (
          ...
          >
            <p className="text-sm text-emerald-700 font-medium">
              ✅ {entries.length} kitap eklendi. Maksimum sayıya ulaştın!
            </p>
          </motion.div>
        )}
      </div>
